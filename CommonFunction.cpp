                            ...
                            const std::string& img_name)
{
    ...
    pos[1].x = SCREEN_WIDTH*0.7;
    pos[1].y = SCREEN_HEIGHT*0.8 - 40;

    ImageObjectBase gBackground;
    //ImageObjectBase logo;

    //bool ret1 = logo.loadImg("image//Logo.png", g_screen);
    bool ret2 = gBackground.loadImg(img_file, g_screen);
